...
//        return resultBuyer
    ...
    override fun selectWithPage(intPage: Int): Array<Buyer> {
        // 매개변수와 값을 줄테니 페이지객체 만들어서 보내주라(여기에는 다양한 정보가 담겨있다)
        // PageRequst.of(몇페이지, 몇개) , 1페이지에 10개가 담겨있다
        val pageRequest = PageRequest.of(intPage, 10)
        // return type이 array라서 타입변경
