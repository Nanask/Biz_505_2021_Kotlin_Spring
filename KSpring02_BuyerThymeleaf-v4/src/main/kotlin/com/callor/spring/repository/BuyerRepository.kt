...
interface BuyerRepository:JpaRepository<Buyer,String> {
    ...
    //import org.springframework.data.domain.Pageable 이걸로 import
    @Query("SELECT B FROM Buyer B") // SelectAll 과 같다?
    // pageable : pageRequest를 넘겨받음, 그래서 10개씩 나누도록 되어있어서 List로 변환해서 넘겨줌
